...
def fetch_data(page):
    url = f'https://www.webmotors.com.br/api/search/car?url=https://www.webmotors.com.br/carros-usados%2Fsp%2Ftoyota%3Festadocidade%3DS%25C3%25A3o%2520Paulo%26tipoveiculo%3Dcarros-usados%26marca1%3DTOYOTA&actualPage={page}&displayPerPage=24&order=1&showMenu=true&showCount=true&showBreadCrumb=true&testAB=false&returnUrl=false&pandora=false'
...
def main():
    ...
    while True:
        ...
        for item in data.get('SearchResults', []):
            car_info = {
                "uniqueId": item.get('UniqueId'),  # Adiciona o uniqueId
    ...
    with open('toyota_cars_data_sp.json', 'w') as f:
